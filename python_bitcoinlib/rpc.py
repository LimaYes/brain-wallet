...
>>> import simplejson
>>> import python_bitcoinlib.rpc
>>> python_bitcoinlib.rpc.json = simplejson
...
from python_bitcoinlib.core import COIN, x, lx, b2lx, CBlock, CBlockHeader, CTransaction, COutPoint, CTxOut
from python_bitcoinlib.core.script import CScript
from python_bitcoinlib.wallet import CBitcoinAddress, CBitcoinSecret
...
class BaseProxy(object):
    ...
    def __init__(self,
        ...
        if service_url is None:
            # Figure out the path to the python_bitcoinlib.conf file
            if btc_conf_file is None:
                ...
                btc_conf_file = os.path.join(btc_conf_file, 'python_bitcoinlib.conf')

            # Extract contents of python_bitcoinlib.conf to build service_url
            with open(btc_conf_file, 'r') as fd:
                ...
                if service_port is None:
                    service_port = python_bitcoinlib.params.RPC_PORT
...
class RawProxy(BaseProxy):
    ...
    def __getattr__(self, name):
        ...
        # Make debuggers show <function python_bitcoinlib.rpc.name> rather than <function
        # python_bitcoinlib.rpc.<lambda>>
        f.__name__ = name
        return f
...
class Proxy(BaseProxy):
    ...
    Unlike ``RawProxy``, data is passed as ``python_bitcoinlib.core`` objects or packed
    ...
    def __init__(self,
        ...
        specified, ``~/.bitcoin/python_bitcoinlib.conf`` or equivalent is used by
    ...
    def submitblock(self, block, params=None):
        ...
        https://en.python_bitcoinlib.it/wiki/BIP_0022 for full specification.
        """
