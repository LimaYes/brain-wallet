...
from python_bitcoinlib.core.key import CPubKey
from python_bitcoinlib.core.serialize import ImmutableSerializable
from python_bitcoinlib.wallet import P2PKHBitcoinAddress
...
class BitcoinMessage(ImmutableSerializable):
    ...
    def stream_deserialize(cls, f):
        magic = python_bitcoinlib.core.serialize.BytesSerializer.stream_deserialize(f)
        message = python_bitcoinlib.core.serialize.BytesSerializer.stream_deserialize(f)
        return cls(message, magic)

    def stream_serialize(self, f):
        python_bitcoinlib.core.serialize.BytesSerializer.stream_serialize(self.magic, f)
        python_bitcoinlib.core.serialize.BytesSerializer.stream_serialize(self.message, f)
