...
is in python_bitcoinlib.core.scripteval
"""
...
class CScript(bytes):
    ...
    def __coerce_instance(cls, other):
        ...
        if isinstance(other, CScriptOp):
            ...
            if 0 <= other <= 16:
                ...
                other = CScriptOp.encode_op_pushdata(python_bitcoinlib.core._bignum.bn2vch(other))
    ...
    def __repr__(self):
        ...
        def _repr(o):
            if isinstance(o, bytes):
                return "x('%s')" % python_bitcoinlib.core.b2x(o)
            else:
                return repr(o)
    ...
    def to_p2sh_scriptPubKey(self, checksize=True):
        ...
        return CScript([OP_HASH160, python_bitcoinlib.core.Hash160(self), OP_EQUAL])
...
def RawSignatureHash(script, txTo, inIdx, hashtype):
    ...
    txtmp = python_bitcoinlib.core.CMutableTransaction.from_tx(txTo)
    ...
    if (hashtype & 0x1f) == SIGHASH_NONE:
        ...
        for i in range(outIdx):
            txtmp.vout.append(python_bitcoinlib.core.CTxOut())
    ...
    hash = python_bitcoinlib.core.Hash(s)
