...
import python_bitcoinlib.signature
...
import python_bitcoinlib.core.script
...
class CECKey:
    ...
    def sign(self, hash): # pylint: disable=redefined-builtin
        ...
        assert 1 == result
        if python_bitcoinlib.core.script.IsLowDERSignature(mb_sig.raw[:sig_size0.value]):
    ...
    def sign_compact(self, hash): # pylint: disable=redefined-builtin
        ...
        sig = python_bitcoinlib.signature.DERSignature.deserialize(sig)
